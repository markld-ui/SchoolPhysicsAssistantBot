...
async def formuls(message : types.Message):
    ...
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap1.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap2.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap3.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap4.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap5.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\mechanicap6.jpg'))
...
async def formuls(message : types.Message):
    ...
    reply = False,
    reply_markup = keyboard)
    media.attach_photo(types.InputFile('utils\\image\\10class\\moleculyarnayap1.jpg'))
    media.attach_photo(types.InputFile('utils\\image\\10class\\moleculyarnayap2.jpg'))
    await bot.send_media_group(message.chat.id, media=media)
